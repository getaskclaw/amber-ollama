...
- Every issue reports: case-set size and hashes, per-case defect-hunt scores and pass/fail, terminal states, cost and latency, environment fingerprint, and qualitative verdicts written under evidence discipline.
...
- **Report card** (2026-W37, blended 23-case tally = W36 21 cases + 2-case makeup): glm-5.3-flash leads the lane at 17/23 (second-tier tie on the suite board), deepseek-v4-flash:0731 at 15/23 — W36 15/21 and 13/21, both 2/2 in the makeup. (Charts as of the main issue; 09-11 Addendum: deepseek-v4.1-flash debuted at 17/23, now tied with glm-5.3-flash — charts refresh next issue.)
  ![W37 report card: blended 23-case bars](docs/images/scorecard-2026-w37.en.png)
- **Face profile** (W36 21-case matrix ∪ W37 2-case makeup, grouped by face): glm-5.3-flash holds the lane's only vision-face pass (suite record is now swe-2-medium's 4.0) and goes 6/6 on ops; d4f:0731 is 5/6 on ops (lost A-a5608487).
...
| UI build | ✗ (delivery rejudged 11/12, still a miss — several 12/12s exist suite-wide) | ✓ (real 740s delivery) |
| vision review | the lane's only pass on record (3.0 in W36; suite record now swe-2-medium 4.0), 2.0 this issue | -2, takes images but can't review |
