# 2026-W38 correction notice — amber-ollama: additive correction to published scores
...
- Count for this repo in this notice: **0 standalone published cells reversed · 5 standalone published cells held** (count = standalone published cells = actual table rows).
- **Scope in one line**: 5 standalone matrix cells across W36 / W37 are held; the lane freeze makes a re-exam infeasible for now.
...
|---|---|---|---|---|---|
| A-ea80d793 | `1d69841b029e` | W37 | Addendum d41f debut ✗ -2 | held (re-exam pending) | named and removed from the board; no re-exam while the lane is frozen; excluded from all aggregates pending re-exam |
| A-cdc3d11a | `dbb207a3118d` | W36 | d4f column ✗ -2 | held (re-exam pending) | same |
| A-ea80d793 | `1d69841b029e` | W36 | d4f column ✗ -2 | held (re-exam pending) | same |
| A-d9b79b46 | `d6d63130ecc6` | W36 | d4f column ✗ | held (re-exam pending) | same |
| A-d9b79b46 | `d6d63130ecc6` | W36 | g53f column ✗ (11/12 re-scored) | held (re-exam pending) | same |

> The table's 5 rows = 5 standalone published cells: W36 d4f column 3 cells + W36 g53f column 1 cell + W37 d41f debut 1 cell.
> **A further 8 papers have no standalone public cell and do not enter the table**: 1 xhigh internal re-test (09-10), 3 spark-lane papers, 1 glm-5.3 (non-flash — a different model id from the published W36 g53f column), and 3 sfail/jjas2 side-chain papers.
